...
export default function Corporate() {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
      {/* Left Side */}
      <div className="flex flex-col justify-center md:justify-start md:items-start pt-16 md:pt-32 items-center px-8 md:px-36 bg-[#FCFAF4] text-white">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-center md:justify-start items-center md:items-start gap-6 my-6">
          {logos.map((logo, idx) => (
