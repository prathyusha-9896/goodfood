...
export default function Corporate() {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
      {/* Left Side */}
      <div className="flex flex-col justify-center px-8 md:px-36 bg-[#FCFAF4] text-white">
        <h1 className="text-4xl md:text-5xl font-bold text-[#333333] leading-tight mb-7">
          {headline}
        </h1>
      ...
      <div
        className="pointer-events-none absolute inset-y-0 left-0 w-1/2 z-10
                  bg-gradient-to-r from-[#FCFAF4] to-[#FCFAF4]/0"
      />
